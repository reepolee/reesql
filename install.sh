#!/usr/bin/env bash
# Install reesql from the latest GitHub Release.
# Usage: curl -fsSL https://raw.githubusercontent.com/reepolee/reesql/main/install.sh | bash
